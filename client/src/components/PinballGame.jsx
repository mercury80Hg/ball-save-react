...
function PinballGame({ user, onLogout }) {
  ...
  return (
    <div className='pinball-game'>
      <Link to='/games' className='' title='games'>
        <div>Pinball Game</div>
        <div className='pinball-game-container'>
          <div className='pinball-game-score pinball-game-current-score'>
            score
            <br />
            <span></span>
          </div>
          <div className='pinball-game-score pinball-game-high-score'>
            high score
            <br />
            <span></span>
          </div>
          <button className='pinball-game-trigger pinball-game-left-trigger'>
            tap!
          </button>
          <button className='pinball-game-trigger pinball-game-right-trigger'>
            tap!
          </button>
        </div>
        {/* partial */}
